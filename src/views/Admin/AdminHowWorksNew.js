...
import { actionHowworksCreate } from "../../redux/actions/howworks";
...
const AdminHowWorksNew = props => {
  ...
  const onSubmit = () => {
    formRef.current.validate(valid => {
      ...
      dispatch(actionHowworksCreate(payload));
...
export default AdminHowWorksNew;