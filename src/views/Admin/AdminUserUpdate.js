...
const AdminUserUpdate = props => {
    ...
    useEffect(() => {
        ...
        axiosPost('/api/user/img', {card:user.card}).then(res => {
            if(res.data){
                            ...
                            <div className="row">
                                <div className="col-md-6 mt-4">
                                    <div className=" zoom-image bg-white d-flex rounded justify-content-center align-items-center position-relative overflow-hidden d-inline-block w-100 bg-image hover-zoom" style={{ height: '100%', zIndex:"5" }}>
                                        {
                                            imgFile ? <img src={typeof imgFile==='object'?URL.createObjectURL(imgFile):imgFile} className="w-100 h-100 img-thumbnail" alt="img"  /> : <img src="imgs/empty.png" className="w-100 h-100 img-thumbnail" alt="img" />
                                        }
                                    </div>
                                </div>
                                <div className="col-md-6 mt-4">
                                ...
                                <div className="col-md-8 mt-4">
                                    <Form.Item label="xDai Wallet address" prop="xDaiWallet">
                                        <Input type="text" value={form.xDaiWallet} onChange={val => onFormChange('xDaiWallet', val)} />
                                    </Form.Item>
                                </div>
                                <div className="col-md-2 mt-4">
